import innovation5 from "../../assets/innovation5.png"
      ...
      <div className=" block sm:hidden w-full">
        ...
        <div className="flex items-center justify-center w-[280px] h-[180px] rounded-[5px] ml-6 relative bg-[#2E453D] ">
          <div className="relative  ">
            ...
            <img className="w-[107px] h-[160px] object-cover rounded-md" src={innovation5} alt="farmervoice" />
