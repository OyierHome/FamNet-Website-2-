...
const InsightPage6 = () => {
  return (
    <div><div className="p-5 top-[180px] font-Inter text-base md:text-xl text-start max-w-[95%] mx-auto px-4 sm:px-6">
      ...
      <div className=" block sm:hidden w-full">
        ...
        <div className="flex items-center justify-center w-[280px] h-[180px] rounded-[5px] ml-6 relative bg-[#2E453D] ">
          <div className="relative  ">
            ...
            <img className="w-[107px] h-[160px] object-cover rounded-md" src={innovation6} alt="farmervoice" />
      ...
      <div className="p-4 md:p-6 top-[105px] font-inter text-base md:text-xl">
        ...
        {/* Description */}
        <p className="mt-2 text-sm sm:text-base md:text-lg lg:text-xl leading-[150%] text-start px-4 sm:px-6 md:px-10 max-w-[95%] md:max-w-[700px] lg:max-w-[900px] mx-auto">
